...
31. advise = ad~ (去使) + vise (看)
           = 去使得(某人)认清(事物)
           = (vt.)忠告、劝告
           = suggest

           to advise sb. to do sth. 是合理的，
           to advise sb. sth. 是不合理的，要用 to advise sb. of sth.
           为什么用of 呢？去使得某人看清他原本没看清的事物，
           因此这个事物和他这个人的关系是「本质属于」的 of

32. revise = re~ (一再) + vise (看)
           = 对(事物)一再察看
           = (vt.)校订、修正


33. devise = de~ (往下) + vise (看)
           = 往(事物)的下方底层去察看
           = (vt.)设计、策划
           = think out

           devise 的意思跟 design 非常接近，但前者意义著重在于「发明」，而后者意义著重在于「设计」，
           We devised how to prevent water pollution. 意义偏向「想出对策」，而不是纯粹做计画而已。
           这个字的名词 device 可真是常用的了，只要是「发明出的小配备、器具」或者是「对策」都叫做device
           注意常指小事物，比如说电话答录机是个 a helpful device，但不能称为 equipment，因为后者指「大型而整体」的配备。


34. supervise = super~ (在...之上) + vise (看)
              = 在(人们)之上监看
              = (vt.)监督

              supervise 常用于老板监督员工的用词老师监考学生用 proctor
              supervise 跟 manage 也不一样，前者重于「监督」，后者重于「提出政策来管理」
...
35. improvise = im~ (in~ 的变体，无) + pro~ (在...之前) + vise (看)
              ...
              这个字是动词，而且不太适用于日常生活口语中，口语中如果说「即席演讲」，一般使用如下的短语：
              to make a speech extempore、to speak offhand、tomake an impromptu speech
...
37. visor = vis (看) + ~or (动作事物)
          = (借着)看的事物
          = (n.)头盔的护面、安全帽舌

          visor 不算太冷僻的单字，因为安全帽分两种，一种是无帽舌的（没有前面挡风镜的），一种是有的。
          有些女孩子化妆或是爱美就会偏向于 a safety helmet with a visor。
          而很多开车的司机会在汽车前窗加上遮阳版，那就叫做 sun visor，
          这是起源于古罗马战士脸上戴的盔甲只露出眼睛的那个护面。
```
